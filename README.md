...
<h1 align="center">Remart's Learning Branch</h1>

<p align="center">
  <img src="https://github.com/Rust-Frog/Teaching-My-Peers-Github-and-Git/actions/workflows/java-compile-check.yml/badge.svg?branch=remart-learning" alt="Build Status"/>
</p>

<p align="center">`░░░░░░░░░░` **0/12** exercises passing</p>

---

## ❌ Compilation Errors — 12/12 File(s) Failed
...
> 🔗 **[Open the failing file in github.dev](https://github.dev/Rust-Frog/Teaching-My-Peers-Github-and-Git/blob/remart-learning/exercises/exercise01_hello_world/HelloWorld.java)** — fix it right in your browser!
...
1. Navigate to your file in the [`exercises/`](https://github.com/Rust-Frog/Teaching-My-Peers-Github-and-Git/tree/remart-learning/exercises) folder
...
2. Make sure you're on branch `remart-learning`
...
> 💡 Or go directly: [github.dev/Rust-Frog/Teaching-My-Peers-Github-and-Git/tree/remart-learning](https://github.dev/Rust-Frog/Teaching-My-Peers-Github-and-Git/tree/remart-learning)
...
git checkout remart-learning

# Open in your editor, fix the code, then:
git add .
git commit -m "Fix: describe what you fixed"
git push origin remart-learning
```
...
**0/12 exercises compiling**

| # | Folder | File | Status |
|:--|:-------|:-----|:------:|
| 1 | `exercises/exercise01_hello_world` | [HelloWorld.java](https://github.com/Rust-Frog/Teaching-My-Peers-Github-and-Git/blob/remart-learning/exercises/exercise01_hello_world/HelloWorld.java) | ❌ |
| 2 | `exercises/exercise01_naming` | [FavoriteMovie.java](https://github.com/Rust-Frog/Teaching-My-Peers-Github-and-Git/blob/remart-learning/exercises/exercise01_naming/FavoriteMovie.java) | ❌ |
| 3 | `exercises/exercise03_variables` | [Variables.java](https://github.com/Rust-Frog/Teaching-My-Peers-Github-and-Git/blob/remart-learning/exercises/exercise03_variables/Variables.java) | ❌ |
| 4 | `exercises/exercise04_math` | [BasicMath.java](https://github.com/Rust-Frog/Teaching-My-Peers-Github-and-Git/blob/remart-learning/exercises/exercise04_math/BasicMath.java) | ❌ |
| 5 | `exercises/exercise05_strings` | [Greeting.java](https://github.com/Rust-Frog/Teaching-My-Peers-Github-and-Git/blob/remart-learning/exercises/exercise05_strings/Greeting.java) | ❌ |
| 6 | `exercises/exercise06_logic` | [AgeCheck.java](https://github.com/Rust-Frog/Teaching-My-Peers-Github-and-Git/blob/remart-learning/exercises/exercise06_logic/AgeCheck.java) | ❌ |
| 7 | `exercises/exercise07_if_else_basics` | [NumberCheck.java](https://github.com/Rust-Frog/Teaching-My-Peers-Github-and-Git/blob/remart-learning/exercises/exercise07_if_else_basics/NumberCheck.java) | ❌ |
| 8 | `exercises/exercise07_loops` | [Counter.java](https://github.com/Rust-Frog/Teaching-My-Peers-Github-and-Git/blob/remart-learning/exercises/exercise07_loops/Counter.java) | ❌ |
| 9 | `exercises/exercise08_number_comparison` | [CompareNumbers.java](https://github.com/Rust-Frog/Teaching-My-Peers-Github-and-Git/blob/remart-learning/exercises/exercise08_number_comparison/CompareNumbers.java) | ❌ |
| 10 | `exercises/exercise09_positive_negative` | [SignCheck.java](https://github.com/Rust-Frog/Teaching-My-Peers-Github-and-Git/blob/remart-learning/exercises/exercise09_positive_negative/SignCheck.java) | ❌ |
| 11 | `exercises/exercise10_maximum` | [FindMax.java](https://github.com/Rust-Frog/Teaching-My-Peers-Github-and-Git/blob/remart-learning/exercises/exercise10_maximum/FindMax.java) | ❌ |
| 12 | `exercises/exercise11_even_odd` | [EvenOrOdd.java](https://github.com/Rust-Frog/Teaching-My-Peers-Github-and-Git/blob/remart-learning/exercises/exercise11_even_odd/EvenOrOdd.java) | ❌ |
...
|:---|:---|
| `git checkout remart-learning` | Switch to your branch |
| `git pull origin remart-learning` | Get latest changes |
| `javac YourFile.java` | Compile locally |
| `java YourFile` | Run your code |
| `git add . && git commit -m "msg"` | Save your work |
| `git push origin remart-learning` | Upload to GitHub |
